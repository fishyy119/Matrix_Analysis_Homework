...
\begin{align*}
    \norm{\alpha_1+\alpha_2}^2_A & = (\alpha_1+\alpha_2)^\HH B^\HH B(\alpha_1+\alpha_2)                                                                   \\
                                 ...
                                 & =\left(\sqrt{\beta_1^\HH\beta_1} + \sqrt{\beta_2^\HH\beta_2}\right)^2                                                  \\
                                 & =\left(\sqrt{\alpha_1^\HH A\alpha_1} + \sqrt{\alpha_2^\HH A\alpha_2}\right)^2                                          \\
...
\answer
$\mat{2 & -3i & 1 \\ 0 & 1 & -2 \\ 1 & 0 & 1}\mat{x_1 \\ x_2 \\ x_3}=AX=\mat{2x_1-3ix_2+x_3 \\ x_2-2x_3 \\ x_1+x_3}$, $\mr{rank}(A)=3$
...
\begin{align*}
    \norm{\alpha_1+\alpha_2}^2 & = (\alpha_1+\alpha_2)^\HH A^\HH A(\alpha_1+\alpha_2)                                                                   \\
                               ...
                               & =\left(\sqrt{\sum_{i=1}^{n}|x_i|^2} + \sqrt{\sum_{i=1}^{n}|y_i|^2}\right)^2                                            \\
                               & =\left(\sqrt{\beta_1^\HH\beta_1} + \sqrt{\beta_2^\HH\beta_2}\right)^2                                                  \\
                               & =\left(\sqrt{\alpha_1^\HH A^\HH A\alpha_1} + \sqrt{\alpha_2^\HH A^\HH A\alpha_2}\right)^2                              \\
                               & =\left(\norm{\alpha_1} + \norm{\alpha_2}\right)^2
\end{align*}
\qed
...
\answer
把$A$分块写成
$$A=\mat{1&0\\0&B},\qquad B=\mat{0.9&-2\\0.08&0.9}.$$
由于$\rho(B)<1$,故$B^k\to0$, 于是
$$A^k=\mat{1&0\\0&B^k}\to\mat{1&0&0\\0&0&0\\0&0&0}$$
故$\lim_{k\to\infty}A^k=\mat{1&0&0\\0&0&0\\0&0&0}$.
\qed
