...
\section{}
已知矩阵 A
$$A=\mat{1&0&0\\ -1&2&-1\\ 0&0&2}$$
求矩阵函数 $f(A)$ 的 Jordan 表示, 并计算 $e^A,\; e^{tA},\; \sin\left(\dfrac{\pi}{2}A\right),\; \cos(\pi A)$.
...
$\sin\left(\dfrac{\pi}{2}A\right)=\mat{1&0&0\\1&0&\pi/2\\0&0&0}$, $\cos(\pi A)=\mat{-1&0&0\\-2&1&0\\0&0&1}$
\qed
...
$|e^A|=|e^J|=|\mr{diag}\{e^{J_1},e^{J_2},\cdots,e^{J_r}\}|=
    \prod_{j=1}^r |e^{J_j}|=\prod_{i=1}^n e^{\la_i}=\exp\left(\sum_{i=1}^{n}\la_i\right)= e^{\Tr{A}}$
